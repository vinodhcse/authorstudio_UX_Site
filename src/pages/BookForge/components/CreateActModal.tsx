...
const CreateActModal: React.FC<CreateActModalProps> = ({ isOpen, onClose, onCreateAct }) => {
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">Create New Act</h2>
              <button
                onClick={handleClose}
                disabled={isCreating}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="act-title" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Act Title
                </label>
                <input
                  id="act-title"
              ...
              <div className="flex gap-3 pt-4">
                ...
                >
                  {isCreating ? 'Creating...' : 'Create Act'}
                </button>
              </div>
            </form>
          </motion.div>
