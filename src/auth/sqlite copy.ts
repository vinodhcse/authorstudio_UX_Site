  ...
  try {
    ...
    if (session) {
      ...
      const result: SessionRow = {
        ...
        refresh_token_enc: session.refreshTokenEnc,
        device_private_key_enc: session.devicePrivateKeyEnc,
        appkey_wrap_salt: session.appkeyWrapSalt,
        appkey_wrap_iters: session.appkeyWrapIters,
        appkey_probe: session.appkeyProbe,
        access_exp: session.accessExp,
        subscription_status: session.subscriptionStatus,
        subscription_expires_at: session.subscriptionExpiresAt,
        subscription_last_checked_at: session.subscriptionLastCheckedAt,
        session_state: session.sessionState,
        sealed_at: session.sealedAt,
